                        ...
                        {filters.division === 'All' ? (
                                            ...
                                            <table className="report-table" style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '20px', fontSize: '0.8rem', tableLayout: 'fixed' }}>
                                                <thead>
                                                    <tr style={{ backgroundColor: '#2c3e50', color: '#fff' }}>
                                                        <th style={{ border: '1px solid #000', padding: '8px', textAlign: 'center', width: '5%' }}>SR NO</th>
                                                        <th style={{ border: '1px solid #000', padding: '8px', textAlign: 'center', width: '10%' }}>CLASS</th>
                                                        <th style={{ border: '1px solid #000', padding: '8px', textAlign: 'left', width: '30%' }}>NAME OF FACULTY</th>
                                                        <th style={{ border: '1px solid #000', padding: '8px', textAlign: 'left', width: '30%' }}>SUBJECT</th>
                                                        <th style={{ border: '1px solid #000', padding: '8px', textAlign: 'center', width: '15%' }}>NO OF STUDENTS</th>
                                                        <th style={{ border: '1px solid #000', padding: '8px', textAlign: 'center', width: '10%' }}>SCORE</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    {groupedFeedbacks[div].map((item, idx) => (
                                                        <tr key={idx}>
                                                            ...
                                                            <td style={{ border: '1px solid #000', padding: '8px', textAlign: 'center' }}>{filters.class}</td>
                            ...
                            feedbacks.map((item, index) => (
                                <div key={index} className="detailed-report-page" style={{
                                    height: '45vh', // Slightly reduced to ensure fit
                                    ...
                                    marginBottom: (index + 1) % 2 !== 0 ? '10px' : '0', // Add some spacing for the dashed line
                                    overflow: 'hidden'
                                }}>
                                    ...
                                    <div style={{ textAlign: 'center', margin: '5px 0', fontSize: '0.9rem', flex: '0 0 auto' }}>
                                        The average feedback for <strong>{item.subjectName}</strong> taught by <strong>{item.facultyName}</strong> given by {item.totalFeedbacks} students is
                                                ...
                                                {feedbackQuestions.theory.map((question, qIdx) => {
                                                    ...
                                                    return (
                                                        <tr key={key}>
                                                            ...
                                                            <td style={{ border: '1px solid #000', padding: '3px', fontSize: '1rem' }}>{question}</td>
